...
5. If your current python version (output of `python3 --version`) is 3.9 or greater, then run `module load StdEnv/2020` or `module load python/3.10`. Run steps 1 and 2 from [Virtual Aging Brain](https://github.com/ins-amu/virtual_aging_brain) under "Python Environment in Linux and MacOS". Alternatively, run the following commands:
```
